                ...
                <div class="info">
                    <el-dropdown style="left: 83.8%">
                        <span class="el-dropdown-link">
                            <div class="top">
                                <img style="width:40px;height:40px;border-radius: 50px 50px 50px 50px;" :src="link+u_image" >
                                <p style="margin-left: 6%"><span style="font-weight: bold;padding-right:5px">{{u_name}}</span> 欢迎您！<i class="el-icon-arrow-down el-icon--right"></i></p>
                            </div>
                        </span>
